...
namespace Gameflow
{
    ...
    [Node(false, "Event/Set Variable", new System.Type[] { typeof(DialogCanvas) })]
    public class SetVariableNode : BaseNodeIO
    {
        ...
        const string tooltip_varName = "The name of the variable to set. Will not parse macros. Naming convention: camelCase";
