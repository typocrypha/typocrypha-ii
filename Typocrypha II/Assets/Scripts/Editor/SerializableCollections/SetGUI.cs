...
namespace SerializableCollections
{
    namespace GUIUtils
    {
        public static class SetGUI
        {
            public delegate void DisplayGUI<T>(T value);
            public delegate void AddGUI();

            public static void StringAddGUI(SerializableSet<string> set, ref string toAdd)
            {
            ...
            public static void EnumAddGUI<T>(this SerializableSet<T> set) where T : System.Enum
            {
            ...
            public static void DoGUILayout<T>(this SerializableSet<T> set, DisplayGUI<T> display, AddGUI addGUI, string title)
            {
