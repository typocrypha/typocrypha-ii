...
namespace Gameflow
{
    public class BattleEvent : ScriptableObject// : ReorderableSOList<BattleEvent>.ListItem
    {
        ...
        public abstract class Function : ScriptableObject//: ReorderableSOListConnectionKnob<Function>.ListItem
        {
        ...
        public abstract class Condition : ScriptableObject//: ReorderableSOList<Condition>.ListItem
        {
